...
namespace ThAmCoSystem.Areas.Customer.Controllers
{
	...
	{
		private readonly ThAmCoSystemContext _dbContext;
		private readonly UserManager<ThAmCoSystemUser> _userManager;

		public ProfileController(ThAmCoSystemContext dbContext, UserManager<ThAmCoSystemUser> userManager)
		{
		...
		[HttpPost]
		public async Task<IActionResult> Edit(ThAmCoSystemUser usr)
		{
